...
paypalrestsdk.configure({
    "mode": "live",  # usar "sandbox" para testes
...
def criar_pagamento(valor, descricao):
    pagamento = paypalrestsdk.Payment({
        ...
        "redirect_urls": {
            "return_url": "https://l-amour-app.streamlit.app/sucesso",
            "cancel_url": "https://l-amour-app.streamlit.app/cancelado"
        },
        "transactions": [{
            "item_list": {
                "items": [{
...
tab1, tab2, tab3, tab4 = st.tabs([
    "Precisas de um bom conselho?",
    "Não sabes o que responder?",
    "Descobre a tua alma gêmea",
    "Descobre os teus futuros filhos"
])
